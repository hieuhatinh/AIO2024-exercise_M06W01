...
# Read vocabulary
vocab_path = '../../model/weights/vocabulary.pth'
absolute_vocab_path = os.path.abspath(os.path.join(
    os.path.dirname(__file__), vocab_path))
vocabulary = torch.load(absolute_vocab_path)

# Read model
model_path = '../../model/weights/text_cnn_model.pt'
absolute_model_path = os.path.abspath(os.path.join(
    os.path.dirname(__file__), model_path))
model = load_model(absolute_model_path,
